package com.helium.modules.combat.autocev;

import com.helium.mixin.ClientPlayerInteractionManagerInvoker;
import com.helium.modules.combat.AutoCev;
...
public final class AutoCevActionExecutor {
    ...
    private boolean isBreakingBlock(BlockPos pos) {
        if (pos == null || module.client().interactionManager == null) return false;
        return ((ClientPlayerInteractionManagerInvoker) module.client().interactionManager).helium$isCurrentlyBreaking(pos);
    }
}