...
import com.helium.modules.combat.autocev.AutoCevActionExecutor;
import com.helium.modules.combat.autocev.AutoCevPlanner;
import com.helium.util.CrashGuard;
...
public class AutoCev extends Module {
    ...
    public AutoCev() {
        super(HeliumAddon.CATEGORY, "auto-cev", "Places obsidian and crystals for a simple, aggressive cev cycle.");
    }
