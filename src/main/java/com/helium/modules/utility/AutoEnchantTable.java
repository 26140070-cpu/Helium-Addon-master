...
import com.helium.util.AddonLog;
import com.helium.util.InteractionGate;
...
public class AutoEnchantTable extends Module {
    ...
    public AutoEnchantTable() {
        super(HeliumAddon.CATEGORY, "auto-enchant-table", "Enchants selected clean inventory items at the nearest enchanting table.");
    }
