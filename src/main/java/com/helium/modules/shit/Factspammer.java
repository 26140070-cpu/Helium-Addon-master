package com.helium.modules.shit;
...
public class Factspammer extends Module {
    ...
    public Factspammer() {
        super(HeliumAddon.SHIT, "Fact spammer", "learning random shit in minecraft");
    }
    ...
    private static final List<String> RANDOM_FACTS = Lists.newArrayList(
            ...
            "Did you know what Helium Addon is the best fucking addon for Meteor Client?"
