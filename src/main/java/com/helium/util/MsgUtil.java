...
public class MsgUtil {
    ...
    public static String getPrefix() {
        return Formatting.DARK_GRAY + "<" + HeliumUtils.rCC() +
    ...
    public static void initModulePrefixes() {
        for (Module module : Modules.get().getGroup(HeliumAddon.CATEGORY)) {
            String name = module.name;
            String color = HeliumUtils.rCC();
    ...
    public static String getModulePrefix(String module) {
        if (!modulePrefixes.containsKey(module)) {
            return String.valueOf(Formatting.DARK_GRAY) + '[' + HeliumUtils.rCC() +
